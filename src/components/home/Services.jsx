      ...
      <div className="container">
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:24}} className="services-grid">
          {services.map(s=>{
            ...
            return (
              <div key={s.title} style={{background:'var(--white)',borderRadius:16,padding:'32px 24px',border:'1px solid var(--border)',transition:'all 0.4s',position:'relative',overflow:'hidden'}}
