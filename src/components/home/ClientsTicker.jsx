  ...
  return (
    <section style={{padding:'72px 0',background:'var(--pale)',overflow:'hidden'}}>
      ...
      <div style={{position:'relative'}}>
        <div style={{position:'absolute',top:0,left:0,bottom:0,width:100,background:'linear-gradient(to right,var(--pale),transparent)',zIndex:2}}/>
        <div style={{position:'absolute',top:0,right:0,bottom:0,width:100,background:'linear-gradient(to left,var(--pale),transparent)',zIndex:2}}/>
        <div style={{display:'flex',gap:24,animation:'ticker 30s linear infinite',width:'max-content'}}>
          {doubled.map((c,i)=>(
