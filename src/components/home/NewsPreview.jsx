          ...
          {latest.map((n, i) => {
            ...
            return (
              <Reveal key={n.slug} delay={i * 0.12}>
                <Link href={`/news/${n.slug}`} style={{ textDecoration: 'none', display: 'block', background: 'var(--white)', borderRadius: 16, border: '1px solid var(--border)', overflow: 'hidden', transition: 'all 0.3s' }}
